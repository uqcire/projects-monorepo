...
const message = 'This is a message from the script setup block'

</script>

<template>
  <div class="flex flex-col items-center justify-center h-screen gap-4">
    <div class="inset-shadow-sm inset-shadow-indigo-500/50 rounded-full">
      <h1 class="font-bold text-6xl text-center opacity-50">
        {{ title }}
      </h1>
    </div>
    <div>
    ...
    <div>
      <p class="text-gray-800 text-2xl overline text-center">
        {{ message }}
      </p>
    </div>
